<%-- 
    Document   : agregarTemporada
    Created on : 05-sep-2020, 14:08:06
    Author     : User
--%>
        ...
        <div class="container mt-5">
            <div class="card border-info">
                <div class="card-header bg-dark">
                    <h5 style="color: whitesmoke;">Agregar Temporada</h5>
                </div>
                <div class="card-body text-center">
                    ...
                    <form method="POST">
                        ...
                        <br>
                        <label>NumeroTemporada</label>
                        <input type="text" name="NumeroTemporada" class="form-control">   
                        <br>
                        <label>CantidadCapitulos</label>
                        <input type="text" name="CantidadCapitulos" class="form-control">   
                        <br>
