<%-- 
    Document   : indexTemporada
    Created on : 05-sep-2020, 13:45:53
    Author     : User
--%>
        ...
        <div class="container mt-5">
            <div class="card  border-info">
                <div class="card-header bg-dark">
                    <a class="btn btn-info regDepto" href="agregarTemporada.htm">Nuevo registro</a>
                </div>
                    ...
                    <table class="table table-hover table-responsive-md table-responsive-sm table-responsive-lg">
                        <thead class="bg-secondary">
                            <tr>                               
                                ...
                                <th style="color: whitesmoke;">NumeroTemporada</th>                               
                                <th style="color: whitesmoke;">CantidadCapitulos</th>                                
                                <th style="color: whitesmoke;">Estacion</th>                                
                        ...
                        <tbody>
                            <c:forEach var="temporada" items="${lsTemporada}">
                                <tr>                               
                                    ...
                                    <td>${temporada.CantidadCapitulos}</td>                               
                                    <td>${temporada.Estacion}</td>                               
                                    <td>${temporada.Ano}</td>
                                    <td>
                                        <a href="editarTemporada.htm?id=${temporada.id}" class="btn btn-success">Editar</a>
                                    </td>
                                    <td>
                                        <a onclick="return confirm('¿Esta seguro?');" href="deleteTemporada.htm?id=${temporada.id}" class="btn btn-dark">Eliminar</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
